// WooCommerce Product CPT Audit Page
// Accessible at /wp-audit/product

export default async function WPAuditProductCPT() {
  // Fetch WooCommerce products (CPT: product)
  ...
  const productFields =
    products && products.length > 0 ? extractFields(products[0]) : {};
